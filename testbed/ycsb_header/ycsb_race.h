...
int inline ExecuteCmd(RACE::RACETable *tb, int num_ops, command cmd, int tid) {
	int oks = 0;
...
int inline MultiThreadAction(RACE::RACETable *tb, int total_ops, int num_threads, command cmd) {
	int ret = -1;
...
int inline ExecuteFullCmd(RACE::RACETable *tb, int num_ops, full_cmd_t *fc, int tid) {
	int oks = 0;
	int offset = num_ops*tid;
...
int inline MultiThreadRun(RACE::RACETable *tb, full_cmd_t *fc, int num_threads) {
	int ret = -1;
