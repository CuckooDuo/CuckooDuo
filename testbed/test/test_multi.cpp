/* 
 * A test program for throughput with different thread number at 70% loaded
 * Insert (Figure 10(h))
 * Lookup (Figure 10(i))
 * Update (Figure 10(j))
 * Delete (Figure 10(k))
...
void test_me(int i, uint64_t cell_number) {
	int test_thread_num = 1<<i;
...
/******************************** insert data **********************************/
    ...
    ME::MultiThreadAction(&tb, check_num, test_thread_num, command::INSERT, test_num);
...
/******************************* query data *********************************/
    ...
    ME::MultiThreadAction(&tb, check_num, test_thread_num, command::READ, test_num);
...
/******************************* update data *********************************/
    ...
    ME::MultiThreadAction(&tb, check_num, test_thread_num, command::UPDATE, test_num);
...
/******************************* delete data *********************************/
    ...
    clock_gettime(CLOCK_MONOTONIC, &time1);
   	...
   	ME::MultiThreadAction(&tb, check_num, test_thread_num, command::DELETE, test_num);
...
void test_race(int i, uint64_t cell_number) {
	int test_thread_num = 1<<i;
...
/******************************** insert data **********************************/
    ...
    RACE::MultiThreadAction(&tb, check_num, test_thread_num, command::INSERT, test_num);
...
/******************************* query data *********************************/
    ...
    RACE::MultiThreadAction(&tb, check_num, test_thread_num, command::READ, test_num);
...
/******************************* update data *********************************/
    ...
    RACE::MultiThreadAction(&tb, check_num, test_thread_num, command::UPDATE, test_num);
...
/******************************* delete data *********************************/
    cout << "deleting..." << endl;
    clock_gettime(CLOCK_MONOTONIC, &time1);
	cout << tb.stash_num << endl;
   	RACE::MultiThreadAction(&tb, check_num, test_thread_num, command::DELETE, test_num);
	cout << tb.stash_num << endl;
    clock_gettime(CLOCK_MONOTONIC, &time2);
...
void test_tea(int i, uint64_t cell_number) {
	int test_thread_num = 1<<i;
...
/******************************** insert data **********************************/
    ...
    TEA::MultiThreadAction(&tb, check_num, test_thread_num, command::INSERT, test_num);

    clock_gettime(CLOCK_MONOTONIC, &time2); 

	int cnt = 0;
	for (int i = 0; i < tb.bucket_number; ++i)
		cnt += tb.table.cell[i];
	cout << cnt << endl;
...
/******************************* query data *********************************/
    ...
    TEA::MultiThreadAction(&tb, check_num, test_thread_num, command::READ, test_num);
...
/******************************* update data *********************************/
    ...
    TEA::MultiThreadAction(&tb, check_num, test_thread_num, command::UPDATE, test_num);
...
/******************************* delete data *********************************/
    ...
    clock_gettime(CLOCK_MONOTONIC, &time1);
	cout << tb.stash_num << endl;
   	TEA::MultiThreadAction(&tb, check_num, test_thread_num, command::DELETE, test_num);
	cout << tb.stash_num << endl;
    clock_gettime(CLOCK_MONOTONIC, &time2);
